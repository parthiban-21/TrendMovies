...
$player_primary_color = "739bd6"; // primary color for loader and buttons
$player_secondary_color = "0052ccaf"; // secondary color for hovers and elements
...
if(isset($_GET['video_id'])) {
    ...
    if(!empty(trim($video_id))) { 
        ...
        if(function_exists('curl_version')) { 
            ...
            $player_url = curl_exec($curl); curl_close($curl); 
        } else { 
